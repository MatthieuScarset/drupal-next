...
```bash
git clone git@github.com:<UsernameOrOrganization>/drupal-template.git next

cd next

# Replace the project name (i.e. 'next').
code .env.example    # ->  DRUSH_OPTIONS_URI=https://next.lndo.site
code .lando.yml      # ->  name: next
